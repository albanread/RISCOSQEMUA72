...
"     * the curve solve below, which is most of the scene's cost.  -outside\n"
"     * is at least a unit, so coverage is 0 for any window taller than 50\n"
"     * pixels, as the exact distance would give. */\n"
